    ...
    return (
        <div className='w-96 m-auto text-center border border-blue-300 rounded-3xl py-20 px-14 bg-sky-50 shadow-lg'>
            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>
                ...
                <input className='border border-blue-300 rounded-md mx-2 mb-2 p-1 shadow-md focus:outline-none focus:ring-1 focus:ring-sky-400' type="text" placeholder="John" name="name" onChange={handleChange} />
                ...
                <button className='bg-white border border-blue-300 rounded-md m-2 p-1 shadow-md transition ease-in-out hover:text-white hover:bg-sky-400 duration-200' type="submit">Sign Up</button>
            </form>
